...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='applications received by rental manager';

--
-- Dumping data for table `accepted_application`
--

INSERT INTO `accepted_application` (`id`, `application_id`, `status`) VALUES
(1, 2, 'accepted');
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='invoice sent to occupant';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='occupant''s request for maintenance';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='the tenant of a unit ';

--
-- Dumping data for table `occupant`
--

INSERT INTO `occupant` (`id`, `user_id`, `unit_id`, `moved_in`, `lease_period`) VALUES
(1, 4, 5, '0000-00-00 00:00:00', NULL),
(2, 4, 4, '2018-08-16 03:33:25', NULL);
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='payment history of occupants';
...
INSERT INTO `unit_application` (`id`, `user_id`, `unit_id`, `id_proof_document`, `id_proof_doc_no`, `status`, `submit_date`) VALUES
(2, 3, 4, 'Drivers Licence', '122', '', '2018-08-16 02:35:44'),
(3, 3, 5, 'Drivers License', '123456', '', '2018-08-16 03:10:52');
...
(8, 'T', 'Bosco ', 'Makori ', 'makori@gmail.com', 715468795, '$5$rounds=535000$6hVJ/xb7FtPSINRu$XllYKvh6uo2vqJu8ftRtVlYwbdVBqkER/6EtbP4SeN2', '2018-08-15 21:06:20');
